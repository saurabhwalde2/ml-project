...
class DataTransformationConfig:
    preprocessor_obj_file_path=os.path.join('artifacts','preprocessor.pkl')  #this will save pickle file in artifacts
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        '''
        try:
            #seprating num and cat columns using hard coding
    ...
    def initiate_data_transormation(self,train_path,test_path):
        try:
            ...
            ## calling the method of feature transformation and assing to variable 
